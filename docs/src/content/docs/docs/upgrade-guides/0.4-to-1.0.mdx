...
## Icons
StudioCMS exports an `Icon` component which can be used to quickly add SVG icons to your site. In v1.0 we've added support for any icons from [Iconify](https://iconify.design/). If you were previously using any of the built-in icons, you now need to prefix their names with `heroicons:`.
