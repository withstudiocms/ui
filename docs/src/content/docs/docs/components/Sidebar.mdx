...
<script>
import { SingleSidebarHelper } from 'studiocms:ui/components/client';
...
---
import { DoubleSidebar } from 'studiocms:ui/components/sidebar';
---
...
<script>
import { DoubleSidebarHelper } from 'studiocms:ui/components/client';
