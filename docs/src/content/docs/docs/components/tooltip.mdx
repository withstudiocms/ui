...
import { Tooltip } from "studiocms:ui/components/tooltip";
...
- `top`: The tooltip will be positioned _above_ the anchor element, otherwise fall back on this order: 'bottom', 'right', 'left'.
- `bottom`: The tooltip will be positioned _below_ the anchor element, otherwise fall back on this order: 'top', 'right', 'left'.
- `left`: The tooltip will be positioned to the _left_ of the anchor element, otherwise fall back on this order: 'right', 'top', 'bottom'.
- `right`: The tooltip will be positioned to the _right_ of the anchor element, otherwise fall back on this order: 'left', 'top', 'bottom'.
