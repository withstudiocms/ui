...
```astro showLinenumbers title="ToastPosition.astro"
---
...
```astro showLinenumbers title="ToastDuration.astro"
---
import { Toaster } from '@studiocms/ui/components';
---
...
```ts twoslash showLinenumbers title="ToastDuration.ts"
// @noErrors
import { toast } from '@studiocms/ui/components';
...
```ts twoslash showLinenumbers title="ToastPersistance.ts"
// @noErrors
import { toast } from '@studiocms/ui/components';
...
```ts twoslash showLinenumbers title="ToastCloseButton.ts"
// @noErrors
import { toast } from '@studiocms/ui/components';
