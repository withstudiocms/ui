  ...
  <TabItem label="Preview">
    <PreviewCard>
      <Select
        label='Select Element'
        multiple
        defaultValue={['opt-1-1', 'opt-2-1', 'opt-3-1', 'opt-4-1', 'opt-5-1', 'opt-6-1', 'opt-7-1', 'opt-8-1', 'opt-9-1', 'opt-10-1', 'opt-11-1']}
        options={[
          { label: "Option 1", value: "opt-1-1" },
          { label: "Option 2", value: "opt-2-1" },
          { label: "Option 3", value: "opt-3-1" },
          { label: "Option 4", value: "opt-4-1" },
          { label: "Option 5", value: "opt-5-1" },
          { label: "Option 6", value: "opt-6-1" },
          { label: "Option 7", value: "opt-7-1" },
          { label: "Option 8", value: "opt-8-1" },
          { label: "Option 9", value: "opt-9-1" },
          { label: "Option 10", value: "opt-10-1" },
          { label: "Option 11", value: "opt-11-1" },
          { label: "Option 12", value: "opt-12-1" },
        ]}
      />
    </PreviewCard>
  </TabItem>
