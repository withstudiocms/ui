...
<Tabs>
  ...
  <TabItem label="Code">
    ```astro showLinenumbers title="SearchSelectDefaultValueExample.astro"
    ---
    import { SearchSelect } from '@studiocms/ui/components';
    ---
...
```astro ins={7-9} showLinenumbers title="SearchSelectFormExample.astro"
---
import { SearchSelect } from '@studiocms/ui/components';
---
...
<Tabs>
  ...
  <TabItem label="Code">
    ```astro showLinenumbers title="FullWidthSearchSelectExample.astro"
    ---
    import { SearchSelect } from '@studiocms/ui/components';
    ---
...
<Tabs>
  ...
  <TabItem label="Code">
    ```astro showLinenumbers title="SearchSelectPlaceholderExample.astro"
    ---
    import { SearchSelect } from '@studiocms/ui/components';
    ---
